...
Cocktail.create(name: "you will stumble")
Cocktail.create(name: "never wake up")
Cocktail.create(name: "don't drink this")
Cocktail.create(name: "where did my legs go")
Cocktail.create(name: "something strong")
p "#{Cocktail.count} cocktails created"
